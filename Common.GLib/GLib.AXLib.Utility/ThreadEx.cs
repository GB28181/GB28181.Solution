...
namespace GLib.AXLib.Utility
{
	public class ThreadEx
	{
		...
		private static Dictionary<Guid, TimerInfo> _dicTimers = new Dictionary<Guid, TimerInfo>();

		private static AQueue<TimerInfo> _queueTimers = new AQueue<TimerInfo>();

		private static AQueue<TimerExecuter> _queueIdleThreads = new AQueue<TimerExecuter>();

		private static AQueue<TimerExecuter> _queueCompleteThreads = new AQueue<TimerExecuter>();

		private static List<TimerExecuter> _timerThreads = new List<TimerExecuter>();
