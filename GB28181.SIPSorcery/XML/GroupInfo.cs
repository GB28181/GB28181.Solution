...
namespace GB28181.Sys.XML
{
    ...
    public class GroupInfo : XmlHelper<GroupInfo>,IDisposable
    {
        ...
        public class GroupInfoItem
        {
            ...
            {
                GroupCode = groupCode; Name = name; ParentID = parentID; GroupType = groupType; GroupMark = groupMark; GroupIdentify = groupIdentify; SubordinatePlatform = subordinatePlatform;
            }
            /// <summary>
            /// 索引
            /// </summary>
