...
namespace GB28181.SIPSorcery.Sys
{
    ...
    public static class TimeConvert
    {
        ...
        public static uint DateToTimeStamp(DateTime date)
        {
           ...
           // (new DateTime(1970, 1, 1, 0, 0, 0, 0).AddTicks(1588291200).Ticks* 10000000)

            string aa = new DateTime(1970,1,1,0,0, 0, 0).AddTicks(1588291200).ToString("yyyy-MM-dd HH:mm:ss");
